...
### The R Notebook
To run the R Notebook, the **R Software** and **RStudio** are required. The following R packages are required: **tidyverse**, **plyr**, **ggplot2**, **effects**, **lmerTest**. If the packages are not installed on your machine yet, please use the *install.packages("<package_name>")* finction.
